...
def generate_gemini_response(prompt, temp, model="gemini-2.5-flash-preview-05-20"):
...
def safe_generate_gemini_response(prompt, temp, model="gemini-2.5-flash-preview-05-20", retries=5):
...
@click.option("--n_valid", type=int, default=10, help="Number of valid responses to collect per prompt")
